...
?>
    <!-- Intro Header -->
    <header id="header" class="intro-post" style="background: #3399db url(<?=$url?>) no-repeat bottom center scroll;   -webkit-background-size: cover;
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div>
                        ...
                        <p class="meta">Posted by <a href="#"> <?php the_author(); ?> </a> on <?php the_date('F j, Y'); ?></p>
                    </div>
                </div>
            </div>
        </div>
